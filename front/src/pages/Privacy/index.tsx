...
export const Privacy = () => (
  <section>
    ...
    <i>Last updated 17/06/2026</i>

    <p>
      This privacy notice for <b>Stream Chat Overlay </b>
      describes how and why we might collect,
      store, use, and/or share your information when you visit our
      website at <NavLink to={ location.origin }>{ location.origin }</NavLink> or any website of
      ours that links to this privacy notice.
    </p>

    <p>
      If you do not agree with our policies and practices, please do not use our services. If you still have
      any questions or concerns, please contact me at business@emy.dev
    </p>
    ...
    <ul>
      <li><b>Third party public personal identifying user id, such as a Twitch user id</b></li>
      <li><b>Authentication tokens when linking an account to allow displaying chat messages</b></li>
      <li><b>Browser metrics and performance data</b></li>
    </ul>
    ...
    <p>
      Access to all the information stored about you can be granted by contacting us at business@emy.dev
